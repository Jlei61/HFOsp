#!/usr/bin/env python3
"""Aggregate rev17 hotspot intervention and freeze Node if mode-selective."""
...
DEFAULT_CONFIG = ROOT / "config/topic4_rev17_node_intervention.json"
EXPECTED_CONFIG_SCHEMA = "topic4_rev17_node_crossed_intervention_v1"
OUTPUT_SCHEMA = "topic4_rev17_node_crossed_intervention_aggregate_v1"
FREEZE_SCHEMA = "topic4_rev17_frozen_node_field_v1"
FROZEN_STATUS = "REV17_NODE_FIELD_FROZEN"
NOT_SELECTIVE_STATUS = "REV17_NODE_INTERVENTION_NOT_SELECTIVE"
...
def aggregate(
    *, config_path: Path = DEFAULT_CONFIG,
    ...
    previous = (
        ...
        base.OUTPUT_SCHEMA, base.FREEZE_SCHEMA, base.FROZEN_STATUS,
        base.NOT_SELECTIVE_STATUS, base.WORKER_STATUS,
        base.EXPECTED_PROJECTION_PARITY_KEYS,
    )
