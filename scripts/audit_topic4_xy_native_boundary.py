#!/usr/bin/env python3
"""Descriptive edge/interior activity check; no objective or threshold changes."""
...
def main():
    ap=argparse.ArgumentParser();ap.add_argument('--round',type=int,default=5)
    ap.add_argument('--candidate',default='replicated_r005_020');args=ap.parse_args()
    root=Path(__file__).resolve().parents[1]/'results/topic4_sef_hfo/joint_rank_space_dual_core_search_v3'
