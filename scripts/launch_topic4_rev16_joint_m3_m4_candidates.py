#!/usr/bin/env python3
"""Launch fresh-network joint candidates with systemd and nohup."""
...
from scripts import monitor_topic4_rev16_joint_m3_m4_candidates as monitor
...
def main(argv: list[str] | None = None) -> None:
    ...
    payload = {
        "status": "REV16_JOINT_CONTROLLER_LAUNCHED" if args.execute
        else "REV16_JOINT_CONTROLLER_DRY_RUN",
        "unit": unit, "expected_git_commit": expected_commit,
        "worker_cap": args.worker_cap,
        "n_jobs": len(manifest["candidates"]) * 3,
