...
def main() -> None:
    ...
    payload = {
        ...
        "state_selection_phase": G.STATE_SELECTION_PHASE,
        "development_evaluation_phase": G.DEVELOPMENT_EVALUATION_PHASE,
        "estimability_uses_development_evaluation_only": True,
