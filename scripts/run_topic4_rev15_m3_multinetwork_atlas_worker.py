#!/usr/bin/env python3
"""Run one frozen M3 coordinate on one fresh rev15 network."""
...
WORKER_STATUS = "REV15_M3_MULTINETWORK_ATLAS_WORKER_COMPLETE"
PREPARE_STATUS = "REV15_M3_MULTINETWORK_ATLAS_WORKER_PREPARED_NO_SNN"
