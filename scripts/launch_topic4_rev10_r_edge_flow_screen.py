...
def main():
    ...
    if (dynamic or resource or dynamic_edge or spatial_ou or spatial_ou_bracket
        ...
        verdict_path = output_root / (
            "confirmation_verdict.json" if spatial_ou_confirmation or natural_kmeans_closeout
    ...
    subprocess.run([
        "notify-send", "Topic 4 rev10-D" if dynamic or resource or dynamic_edge or spatial_ou or spatial_ou_bracket or spatial_ou_confirmation or spatial_ou_kmeans_grid or spatial_ou_kmeans_selection or continuous_field_kmeans or natural_kmeans_closeout else "Topic 4 rev10-R",
        f"{completion}; workers={maximum}",
    ], check=False)
    print(json.dumps({
        "status": (
            completion if dynamic or resource or dynamic_edge or spatial_ou or spatial_ou_bracket or spatial_ou_confirmation or spatial_ou_kmeans_grid or spatial_ou_kmeans_selection or continuous_field_kmeans or natural_kmeans_closeout
