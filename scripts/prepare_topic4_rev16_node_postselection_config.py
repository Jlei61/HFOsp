...
EXPECTED_CANDIDATE_SCHEMA = "topic4_rev16_joint_m3_m4_candidates_v1"
...
def build_config(
    *, candidate_config_path: Path, candidate_aggregate_path: Path,
    ...
    payload["selected_candidate"]["selection_source"] = (
        "training-only rev16 joint M3+M4 fresh-network aggregate before natural "
        "KMeans, figure, or patient held-out access"
    )
