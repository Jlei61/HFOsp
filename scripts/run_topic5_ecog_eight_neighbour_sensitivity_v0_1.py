#!/usr/bin/env python3
"""Train the pre-specified eight-neighbour true-vs-wrong-grid sensitivity."""
...
def main() -> None:
    ...
    parser.add_argument("--output-root", type=Path, default=Path(
        "results/topic5_ecog_physical_neighborhood_rnn_v0_1/training_eight_neighbour"
    ))
        ...
        for graph_index in range(-1, 31):
            for subject in args.subjects:
                ...
                units.append({
                    ...
                    "graph_path": str(args.graph_root / subject / "eight_neighbour" / f"{graph_id}.npz"),
                })
