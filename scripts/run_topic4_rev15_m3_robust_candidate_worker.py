#!/usr/bin/env python3
"""Run one frozen rev15 robust M3 field on a fresh network."""
...
WORKER_STATUS = "REV15_M3_ROBUST_CANDIDATE_WORKER_COMPLETE"
PREPARE_STATUS = "REV15_M3_ROBUST_CANDIDATE_WORKER_PREPARED_NO_SNN"
