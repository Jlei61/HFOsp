...
TRACKED_MODULES = (
    ...
    "src/topic4_rev9_local_response.py",
    ...
    "src/topic4_component_pair_edge.py",
    ...
    "scripts/freeze_topic4_core_field_stage3_rev8_training_target.py",
    ...
    "scripts/reconcile_topic4_rev9_node_kick_windows.py",
    "scripts/aggregate_topic4_rev9_edge_alpha_selection.py",
    ...
    "scripts/aggregate_topic4_rev9l_component_pair_phase1.py",
