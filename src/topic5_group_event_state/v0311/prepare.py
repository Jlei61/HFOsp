...
class Prepared:
    ...
    def rich_summary(self,encoder,packet_index):
        ...
        return encoder(self.tokens[idx],self.groups[idx],self.part[idx],self.event[idx],
                       self.event_valid[idx],self.shaft_frac[idx],self.size[idx],
                       self.gap[idx],row,len(packet_index))
