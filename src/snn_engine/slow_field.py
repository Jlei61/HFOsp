...
NotImplementedError on purpose -- a stub that returns plausible values gets called in
production and silently contaminates a screen (CLAUDE.md §6). Implement per the plan.
The default values in SpatialSlowFieldConfig ARE the locked spec defaults (§B5.2-B5.3);
the bodies are not. !!!
"""
...
class SpatialSlowFieldConfig:
    ...
    def validate(self) -> None:
        ...
        Implemented per the plan (Task 1)."""
