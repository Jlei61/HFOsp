...
- 结果：`results/topic4_sef_itp/{phase1_spatial_geometry, phase2_temporal_x_geometry, phase3_ictal_adjacent, direction_axis}/`
...
- 脚本：`scripts/{run,summarize,plot}_sef_itp_phase{1,2,3}*.py`、`scripts/{run,plot}_sef_itp_direction_axis.py`
