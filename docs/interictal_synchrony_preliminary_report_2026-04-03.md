...
> 统计来源：`results/pr6_analysis_soz/pr6_statistics_summary.json`
...
| PR6 统计 JSON | `results/pr6_analysis_soz/pr6_statistics_summary.json` |
| PR6 Figures A–F | `results/pr6_analysis_soz/figures/` |
| Figure F: event rate boxplot | `results/pr6_analysis_soz/figures/figure_f_event_rate.png` |
