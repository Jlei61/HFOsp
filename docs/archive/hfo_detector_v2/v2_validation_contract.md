...
见 `docs/archive/topic1/propagation/interictal_group_event_internal_propagation.md` PR-2.5 段，
...
- `docs/archive/topic1/propagation/interictal_group_event_internal_propagation.md` — PR-2.5
