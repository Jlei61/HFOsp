...
- **Refractory-shadow is NOT the main driver:** 0/379 local events fall within 250 ms after a readable_global; local inter-event gap (median 268 ms) ≈ global (283 ms).
