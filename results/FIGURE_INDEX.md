...
| [topic5_ictal_recruitment/field_reversal/figures/](topic5_ictal_recruitment/field_reversal/figures/) | A 线上游 gate：间期两模板 TA/TB 摊成空间场后是否反向对齐 (signed field corr vs within-shaft null) + 场平滑是否比离散触点更去噪 (LOO 头对头)；broad+narrow 双底物分开报告，narrow accountability 单列。**preliminary（n_perm=300，待 n_perm=1000 全量复核 + 用户签核）**：反向逐病人二项 gate broad 7/26 (p=2.2e-4) / narrow 9/26 (p=2.8e-6) 显著；去噪假设被 LOO 头对头证伪（field 26/26 输给 contact，p=3.0e-8） |
