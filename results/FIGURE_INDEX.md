...
| [topic4_criticality_m2/figures/](topic4_criticality_m2/figures/) | M3A-v2.2 criticality Milestone 2：两段式点火(linear_ignition=core_localized)/铺开(nonlinear_spread=undetermined，epsilon-sensitive)判读诊断图，与 M1 CSD unresolved 并存展示 |
