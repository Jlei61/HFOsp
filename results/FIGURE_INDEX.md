...
| 5 group-event state | [group_event_state/core_evidence/figures/](group_event_state/core_evidence/figures/) | 三张 candidate 核心证据图：H1 未来事件块、H2a 状态调制事件继续/规模/触点集合、H2b 发作迁移与 H3 反馈。当前三患者 pilot 未建立慢预测状态；H2b/H3 尚未运行，空接口不等于阴性。 |
