...
- Mechanistic readout: population-mean X reaches 0.488 at minimum and ends at 0.501, above the archived late-bout reference 0.380; that reference is not a universal offset boundary
...
- Scientific boundary: this one-seed result rejects autonomous offset by the locked K_y=3 implementation within the preregistered target window. It does not establish an asymptotic X floor, identify spatial coverage as the unique blocker, or reject activity-dependent relay depression as a mechanism family.
